...
export default function ContactPage() {
    ...
    const handleSubmit = (event) => {
        ...
        if (!form.name.trim() || !form.email.trim() || !form.message.trim()) {
            window.alert('Mohon lengkapi semua kolom yang tersedia.');
            return;
        }

        window.alert(`Terima kasih, ${form.name}! Pesan Anda telah kami terima. Kami akan segera merespons melalui email: ${form.email}.`);
                ...
                <div className="container">
                    <div className="contact-grid">
                        ...
                        <div className="contact-form-wrapper reveal">
                            <form className="classic-form" action="#" method="post" onSubmit={handleSubmit}>
